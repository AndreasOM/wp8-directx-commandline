...
"C:\Program Files (x86)\Windows Kits\8.0\bin\x86\fxc.exe" /nologo /E"main" /T ps_4_0_level_9_3 /Fo "%PROJECT_BASE%\Debug\PhoneDirect3DApp2\SimplePixelShader.cso" /Zi SimplePixelShader.hlsl

"C:\Program Files (x86)\Windows Kits\8.0\bin\x86\fxc.exe" /nologo /E"main" /T vs_4_0_level_9_3 /Fo "%PROJECT_BASE%\Debug\PhoneDirect3DApp2\SimpleVertexShader.cso" /Zi SimpleVertexShader.hlsl
...
"C:\Program Files (x86)\Microsoft Visual Studio 11.0\VC\WPSDK\WP80\bin\link.exe" /ERRORREPORT:QUEUE /OUT:"%PROJECT_BASE%\Debug\PhoneDirect3DApp2\PhoneDirect3DApp2.exe" /INCREMENTAL /NOLOGO /LIBPATH:"C:\Program Files (x86)\Windows Phone Kits\8.0\lib\x86" /LIBPATH:"C:\Program Files (x86)\Microsoft Visual Studio 11.0\VC\WPSDK\WP80\lib" d3d11.lib WindowsPhoneCore.lib RuntimeObject.lib PhoneAppModelHost.lib /NODEFAULTLIB:ole32.lib /MANIFEST:NO /DEBUG /PDB:"%PROJECT_BASE%\Debug\PhoneDirect3DApp2\PhoneDirect3DApp2.pdb" /SUBSYSTEM:WINDOWS /TLBID:1 /WINMD:NO /WINMDFILE:"%PROJECT_BASE%\Debug\PhoneDirect3DApp2\PhoneDirect3DApp2.winmd" /DYNAMICBASE /NXCOMPAT /MACHINE:X86 Debug\PhoneDirect3DApp2.obj Debug\CubeRenderer.obj Debug\Direct3DBase.obj
...
set XAP=Test-XAP
md %XAP%
copy "%PROJECT_BASE%\Debug\PhoneDirect3DApp2\PhoneDirect3DApp2.exe" %XAP%
copy "%PROJECT_BASE%\Debug\PhoneDirect3DApp2\*.cso" %XAP%
